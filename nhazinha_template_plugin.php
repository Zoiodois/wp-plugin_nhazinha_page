...
require_once plugin_dir_path( __FILE__ ) . 'repath.php';


// Registrando o hook de ativação
//register_activation_hook(__FILE__, 'plugin_path_finder');
register_activation_hook(__FILE__, 'plugin_path_finder');

// Registra os template parts ao carregar o plugin
function meu_plugin_register_template_parts() {
    $template_part_path = plugin_dir_path( __FILE__ ) . 'templates/page-nhazinha.html';
